...
class AppStyle {
  ...
  static List<Color> cardsColor = [
    Color.fromARGB(255, 94, 116, 244),
    Color.fromARGB(255, 86, 198, 232),
    Color.fromARGB(255, 86, 232, 171),
    Color.fromARGB(255, 115, 232, 86),
    Color.fromARGB(255, 225, 234, 98),
    Color.fromARGB(255, 242, 166, 94),
    Color.fromARGB(255, 246, 102, 119),
    Color.fromARGB(255, 238, 95, 188),
    Color.fromARGB(255, 172, 103, 246),
